...
const ProjectDetails = () => {
    ...
    return (
        <div className='pt-20 md:px-20'>
            <p className='text-3xl text-green-500 banner-font py-3'>{name}</p>
            ...
            <div className='md:flex  justify-between py-20'>
                <p className='text-3xl md:w-1/4 text-center text-green-500 banner-font py-3'>Description</p>
                <p className='text-xl px-5 text-justify md:w-4/6 banner-font'>{description}</p>
            </div>
            <div className='md:flex justify-between py-5'>
                <p className='text-3xl md:w-1/4 text-center text-green-500 banner-font py-3'>Features</p>
            ...
            <div className='md:flex justify-between py-20'>
                <p className='text-3xl md:w-1/4 text-center text-green-500 banner-font'>Technologies</p>
