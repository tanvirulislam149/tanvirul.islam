...
const RightSection = () => {
  ...
  return (
    <motion.div ref={skySection} style={{ translateX: x }} className="flex justify-end xl:pr-20 md:pt-40 pt-96 pl-2 pr-6 lg:px-10 banner-right-img absolute top-64 sm:top-0 right-0 sm:w-7/12 ml-auto">
