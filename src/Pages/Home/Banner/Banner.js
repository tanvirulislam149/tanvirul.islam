    ...
    return (
        <div className='md:flex justify-between md:px-20 h-screen items-center'>
            ...
            <div className='flex items-center'>
                ...
                <div>
                    <button type="button" class="inline-block p-2 bg-green-300 border-2 border-green-300 text-black font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-black hover:text-white hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"><a href="https://www.facebook.com/md.tanvirul.islam.792/" target={"blank"}><FaFacebookF className='h-6 w-6' /></a></button> <br />
                    <button type="button" class="my-3 inline-block p-2 bg-green-300 border-2 border-green-300 text-black font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-black hover:text-white hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out"> <a href="https://github.com/tanvirulislam149" target={"blank"}><FaGithub className='h-6 w-6' /></a></button> <br />
