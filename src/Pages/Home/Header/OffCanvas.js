...
const OffCanvas = () => {
    return (
        <div>
            ...
            <div class="offcanvas offcanvas-end fixed bottom-0 flex flex-col max-w-full invisible bg-clip-padding shadow-sm outline-none transition duration-300 ease-in-out bg-green-300 text-black top-0 right-0 border-none w-80" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                ...
                <div class="offcanvas-body text-center font-bold flex-grow p-4 overflow-y-auto">
                    <nav className='flex flex-col'>
                        <Link to="/home" className='text-3xl py-2'>Home</Link>
                        <Link to="/blogs" className='text-3xl py-2'>Blogs</Link>
                    </nav>
                </div>
            </div>
        </div>
