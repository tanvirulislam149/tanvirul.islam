...
const Header = () => {
  ...
  return (
    <div
      className={`${
        navbar ? "text-black" : "bg-black text-white"
      } nav-transition flex justify-between fixed-top px-5 md:px-20`}
    >
      <nav
        class="
        relative
      ...
      >
        <div class="container-fluid w-full flex flex-wrap items-center justify-between md:bg-transparent pb-0 pr-0">
          ...
          <div
            class="collapse navbar-collapse flex-grow banner-font items-center"
