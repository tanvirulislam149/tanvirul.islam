...
const AboutMe = () => {
  return (
    ...
    //       <div className="mx-3 rounded-full bg-sky-500 h-6 w-6"></div>
    //       <div className="rounded-full bg-sky-500 h-6 w-6"></div>
    //     </div>
    ...
    //     <div className="h-full p-56 bg-sky-500 invisible md:visible absolute top-0 right-0"></div>
    //     <div className="w-full p-36 bg-sky-500 visible md:invisible absolute left-0 bottom-0 "></div>
    //     <motion.img
    //       initial={{ x: 200, opacity: 0 }}
    //       whileInView={{ x: 0, opacity: 1 }}
    //       viewport={{ once: true, amount: 0 }}
